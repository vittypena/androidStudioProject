...
class FilmDataActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var imgUri: Uri? = null
        /*
        val extraIntent_titulo = intent.getStringExtra(EXTRA_FILM_TITLE)
        var extraIntent_url = intent.getStringExtra(EXTRA_URL_IMDB)
        val extraIntent_director = intent.getStringExtra(EXTRA_DIRECTOR)
        val extraIntent_anio = intent.getStringExtra(EXTRA_ANIO_LANZAMIENTO)
        val extraIntent_genero = intent.getStringExtra(EXTRA_GENERO)
        val extraIntent_formato = intent.getStringExtra(EXTRA_FORMATO)
        val extraIntent_imagen = intent.getStringExtra(EXTRA_IMAGEN)
         */
